...
export const AppHeader = ({isLoggedin}) => {
  ...
  const toggle_dropdown = () => {
    ...
    const toggle_mobile = () => {
      setMobile(!isMobile); // Toggle the state
    ...
    <header>
      ...
      >
        ...
        <div className="flex gap-3 items-center mr-4">
          <li
            className={`font-medium text-lg p-3 cursor-pointer hover:bg-slate-300 dark:hover:bg-slate-800 sm:p-0 sm:hover:bg-transparent text-gray-600 hover:text-primary transition-colors ${
              isLoggedin ? "hidden" : ""
            }`}
          ...
          >
            ...
            <div
              className={`drop-down w-30 overflow-hidden bg-white rounded-md shadow absolute top-19 right-3 ${
                isMobile ? "" : "hidden"
              }`}
            >
              <ul>
